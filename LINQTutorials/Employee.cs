...
namespace LINQTutorials
{
    ...
    public class OfficeEmployee
    {
        ...
        public static List<OfficeEmployee> GetEmployeeDetails()
        {
            ...
            empCollection.Add(new OfficeEmployee { Id = 101, Name = "Alex", Age = 23, Gender = Gender.male, Salary = 33000.00M, Departments = new List<string> { "IT" }, ManagerId = 1 });
            empCollection.Add(new OfficeEmployee { Id = 102, Name = "Ramsey", Age = 23, Gender = Gender.male, Salary = 35000.00M, Departments = new List<string> { "IT" }, ManagerId = 1 });
            empCollection.Add(new OfficeEmployee { Id = 103, Name = "Jenny", Age = 29, Gender = Gender.female, Salary = 43000.00M, Departments = new List<string> { "IT" }, ManagerId = 2 });

            empCollection.Add(new OfficeEmployee { Id = 104, Name = "Nile", Age = 59, Gender = Gender.male, Salary = 143000.055M, Departments = new List<string> { "Finance", "Accounting" }, ManagerId = 2 });
